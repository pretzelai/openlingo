...
All the files generated during RPI should be saved into a new folder inside /agent-docs named "DD-MMM-YYYY-description-of-thing-to-implement". If the user provided a task.md file, move also into this folder.
